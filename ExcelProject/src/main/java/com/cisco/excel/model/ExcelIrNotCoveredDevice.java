...
/**
 * The persistent class for the excel_ir_not_covered_devices database table.
 * 
 */
@Entity
@Table(name="excel_ir_not_covered_devices")
@NamedQuery(name="ExcelIrNotCoveredDevice.findAll", query="SELECT e FROM ExcelIrNotCoveredDevice e")
public class ExcelIrNotCoveredDevice implements Serializable {
	...
	public ExcelIrNotCoveredDevice() {
	}
