...
/**
 * The persistent class for the EXCEL_IR_REPORTED_CHASSIS database table.
 * 
 */
@Entity
@Table(name="EXCEL_IR_REPORTED_CHASSIS")
@NamedQuery(name="ExcelIrReportedChassi.findAll", query="SELECT e FROM ExcelIrReportedChassi e")
public class ExcelIrReportedChassi implements Serializable {
