...
/**
 * The persistent class for the excel_ir_covered_devices database table.
 * 
 */
@Entity
@Table(name="excel_ir_covered_devices")
@NamedQuery(name="ExcelIrCoveredDevice.findAll", query="SELECT e FROM ExcelIrCoveredDevice e")
public class ExcelIrCoveredDevice implements Serializable {
