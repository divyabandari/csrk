...
/**
 * The persistent class for the excel_ir_all_contracts database table.
 * 
 */
@Entity
@Table(name="excel_ir_all_contracts")
@NamedQuery(name="ExcelIrAllContract.findAll", query="SELECT e FROM ExcelIrAllContract e")
public class ExcelIrAllContract implements Serializable {
