 ...
 */
public class SNTCNotCoveredSheetHandler extends DefaultHandler {

//	protected static final Logger logger = LoggerFactory.getLogger(SNTCNotCoveredSheetHandler.class);
	...
	public SNTCNotCoveredSheetHandler(SharedStringsTable sst) {
		this.sst = sst;
	}
	...
	public void startElement(String uri, String localName, String name,
		...
		if (name.equals("c")) {
			...
			try {
				...
				matcher = Pattern.compile(ExcelConstants.NOT_COVERED_DATA_COLUMN_REGEX)
...
//				logger.debug("THE COLUMN NAME IS: " + currentColumName + " ROW NUMBER IS: " + currentRowNumber);
				if (currentRowNumber >= ExcelConstants.NOT_COVERED_DATA_START_ROW_NUMBER
