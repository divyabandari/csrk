...
/**
 * The persistent class for the EXCEL_SNTC_REPORTED_CHASSIS database table.
 * 
 */
@Entity
@Table(name="EXCEL_SNTC_REPORTED_CHASSIS")
@NamedQuery(name="ExcelSntcReportedChassi.findAll", query="SELECT e FROM ExcelSntcReportedChassi e")
public class ExcelSntcReportedChassi implements Serializable {
	...
	public ExcelSntcReportedChassi() {
	}
